        ...
        static Parser<VpdBone> Bone
        {
            get
            {
                return
                    ...
                    from translation in (
                        from x in SignedFloat.Select(n => Convert.ToSingle(n))
                        from _c0 in Parse.Char(',')
                        from y in SignedFloat.Select(n => Convert.ToSingle(n))
                        from _c1 in Parse.Char(',')
                        from z in SignedFloat.Select(n => Convert.ToSingle(n))
                    ...
                    from rotation in (
                        ...
                        from w in SignedFloat.Select(n => Convert.ToSingle(n))
                        from _sc in Parse.Char(';')
